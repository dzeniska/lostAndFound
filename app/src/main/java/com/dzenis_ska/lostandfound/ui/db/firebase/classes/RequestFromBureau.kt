...
data class RequestFromBureau(
    ...
    fun toAddApplicationFragmentArguments(isEditApplication: Boolean = false): AddApplicationFragmentArguments = AddApplicationFragmentArguments(
        key = key,
        ...
        isEditApplication = isEditApplication
    )
